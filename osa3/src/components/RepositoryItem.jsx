...
export const renderItem = ({ item }) => {
  ...
  <View>   
        ...
        <Text fontWeight="bold"fontSize="subheading" color="secondary">{ item.fullName }</Text>
        <Text fontWeight="normal"fontSize="subheading" color="textSecondary">{item.description }</Text>
        </View>
        </View>
          <View style={styles.flexItemA}>
          <Image style={{width: 50}} /> 
          <View style={styles.flexItemC}>
        <Text fontWeight="normal"fontSize="subheading" color="white">{item.language }</Text>
        </View>
         </View>
         <View style={styles.flexItemLowerRows}>
         <View style={styles.flexItemLowerColumns}>  
        <Text fontWeight="bold"fontSize="subheading" color="secondary">{roundedStars}</Text>
        <Text fontWeight="normal"fontSize="subheading" color="textSecondary">Stars</Text>
        </View>
         <View style={styles.flexItemLowerColumns}>  
        <Text fontWeight="bold"fontSize="subheading" color="secondary">{roundedForks} </Text>
         <Text fontWeight="normal"fontSize="subheading" color="textSecondary">Forks</Text>
         </View>
          <View style={styles.flexItemLowerColumns}>  
        <Text fontWeight="bold"fontSize="subheading" color="secondary">{item.reviewCount } </Text>
        <Text fontWeight="normal"fontSize="subheading" color="textSecondary"> Rewiews </Text>
        </View>
         <View style={styles.flexItemLowerColumns}>  
        <Text fontWeight="bold"fontSize="subheading" color="secondary">{item.ratingAverage} </Text>
